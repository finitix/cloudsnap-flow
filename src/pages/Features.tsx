    ...
    <PublicLayout>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 pt-20 pb-16 md:pt-28 md:pb-24 text-center relative z-10">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
            From auto-detection to monitoring, Cloudsnap handles the entire deployment lifecycle so you can focus on building.
          </p>
          <Link to="/auth">
      ...
      <section className="section-padding-lg" style={{ background: "linear-gradient(180deg, hsl(210 40% 98%), hsl(200 50% 97%))" }}>
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-muted-foreground mb-8 text-lg">Start for free. No credit card required.</p>
          <Link to="/auth">
